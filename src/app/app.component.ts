...
export class AppComponent {
  ...
  checkTrack() {
    this.http
      .get('http://79.99.41.29/api/zrc/tracker/lastyearchange')
  ...
  updateLastYearChange() {
    ...
    this.http
      .put('http://79.99.41.29/api/zrc/tracker/lastyearchange', bodyData)
      .subscribe((resultData: any) => {
        if (resultData.status === false) {
  ...
  updateSl() {
    ...
    this.http
      .put('http://79.99.41.29/api/zrc/tracker/updatelastsl', bodyData)
      .subscribe((resultData: any) => {
