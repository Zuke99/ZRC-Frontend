...
export class RegisterComponent implements OnInit{
  ...
  register(){
    ...
    this.http.post("http://79.99.41.29/api/zrc/register/registeruser",bodyData).subscribe((resultData : any ) => {
      (error : any) => {
  ...
  deleteUser(serial : number){
    this.http.delete("http://79.99.41.29/api/zrc/user/delete/deleteuser"+"/"+serial).subscribe((resultData : any) => {
