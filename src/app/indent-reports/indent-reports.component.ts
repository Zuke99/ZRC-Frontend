...
export class IndentReportsComponent implements OnInit {
  ...
  getDetails() {
    ...
    this.http
      .get(
        'http://79.99.41.29/api/zrc/indentproduct' + '/' + encodedParameter
      )
  ...
  getIndentRange() {
    ...
    this.http
      .get('http://79.99.41.29/api/zrc/indent/getindentrange', {
        params: params,
      })
      .subscribe((resultData: any) => {
        (error: any) => {
  ...
  onCheckBoxChange(details: any) {
    ...
    if (this.checkCorrectIndent(this.indentData, details)) {
      ...
      this.http
        .put('http://79.99.41.29/api/zrc/indentreport/status', bodyData)
        .subscribe((resultData: any) => {
          (error: any) => {
          ...
          this.http
            .put(
              'http://79.99.41.29/api/zrc/update/updatestatus' +
                '/' +
                details.zrc_serial,
              bodyData
            )
  ...
  const iso_zrc_valid_from2: string =
    ...
    this.http.post("http://79.99.41.29/api/zrc/userindent/getalluserindentrange",bodyData).subscribe((resultData : any) => {
  ...
  userGetDetails() {
    ...
    this.http
      .post(
        'http://79.99.41.29/api/zrc/userindentproduct' + '/' + encodedParameter, bodydata
      )
      .subscribe((resultData: any) => {
        (error: any) => {
          alert('Search Failed');
  ...
  userGetIndentRange() {
    ...
    this.http
      .post('http://79.99.41.29/api/zrc/indent/usergetindentrange', bodyData)
      .subscribe((resultData: any) => {
        (error: any) => {
          console.log('error getting indent range ', error);
        };
